...
$(document).ready(function() {
    ...
    $win.scroll(function() {
        if ($(this).scrollTop() > 42) {
            $('#gridgum-main-header').addClass("sticky-nav");
        } else {
            $('#gridgum-main-header').removeClass("sticky-nav");
        }
    });
    ...
    $("#gridgum-owl-slide-1").owlCarousel({
        loop: true,
        margin: 0,
        responsiveClass: true,
        items: 1,
    ...
    // Single Owl Slider
    $("#gridgum-owl-slide-2").owlCarousel({
        loop: true,
        responsiveClass: true,
        items: 1,
        nav: false,
    ...
    $("#gridgum-owl-slide-3").owlCarousel({
        loop: true,
        margin: 30,
        responsiveClass: true,
        items: 1,
    ...
    $("#gridgum-owl-slide-4").owlCarousel({
        loop: true,
        margin: 76,
        autoplay: true,
